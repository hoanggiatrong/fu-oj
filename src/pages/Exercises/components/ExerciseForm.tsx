...
const ExerciseForm = ({
    ...
    return (
        <Form
            className="ex-creation-form-by-ai"
            form={form}
            layout="vertical"
            initialValues={{
                topic: selectedTopic,
        ...
        >
            ...
            <div>
                <Form.Item label="Tổng số test case mỗi bài tập" style={{ marginBottom: 16 }}>
            ...
            <div>
                <Form.Item name="prompt" label="Prompt (tùy chọn)">
                    <Input.TextArea
                        rows={6}
